...
best_lecturer_1 = Lecturer('Дмитрий', 'Камша')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Алексей', 'Пехов')
best_lecturer_2.courses_attached += ['Java']

best_lecturer_3 = Lecturer('Николай', 'Второв')
best_lecturer_3.courses_attached += ['Python']

cool_rewiewer_1 = Reviewer('Александр', 'Маков')
cool_rewiewer_1.courses_attached += ['Python']
cool_rewiewer_1.courses_attached += ['Java']

cool_rewiewer_2 = Reviewer('Владимир', 'Краснов')
cool_rewiewer_2.courses_attached += ['Python']
cool_rewiewer_2.courses_attached += ['Java']

student_1 = Student('Сергей', 'Рыцарев')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Ибрагим', 'Лесорубов')
student_2.courses_in_progress += ['Java']
student_2.finished_courses += ['Введение в программирование']

student_3 = Student('Станислав', 'Стульев')
